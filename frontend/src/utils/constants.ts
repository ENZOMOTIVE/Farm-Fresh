...
export const SAMPLE_PRODUCTS: Product[] = [
  ...
  { id: '10', name: 'yuzuMatchaCheesecake', description: 'desc.yuzuMatchaCheesecake', price: 8.99, image: '/yzu-matcha.jpg', category: 'chiffon_cakes', inStock: true, rating: 4.8, reviews: 124, tags: ['organic', 'free-range', 'local'] },
